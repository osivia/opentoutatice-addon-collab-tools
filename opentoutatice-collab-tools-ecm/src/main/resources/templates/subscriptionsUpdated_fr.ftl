                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="background-color:#fff;padding:8px 20px;">
                        ...
                        <P>${author} (${htmlEscape(principalAuthor.firstName)} ${htmlEscape(principalAuthor.lastName)}) vous a inscrit aux &eacute;v&eacute;nements <B>${notifName}</B> du document suivant:</P>
                    ...
                    <tr>
                      <td style="background-color:#f7f7f7;border-top:1px dashed #e9ecef;text-align:center;padding:8px 20px;">
                        ...
                        <p><a href="${docUrl}">Cliquez-ici</a> pour consulter le document dans Nuxeo.</p>
                        <p><a href="${baseUrl}/nxhome/default@view_home?tabIds=USER_CENTER%3ANotification">Cliquez-ici</a> pour gérer vos abonnements.</p>
                        </div>
                      </td>
                    </tr>
                  </tbody>
