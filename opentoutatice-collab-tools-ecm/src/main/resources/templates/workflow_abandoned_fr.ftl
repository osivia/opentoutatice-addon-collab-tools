                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="background-color:#fff;padding:8px 20px;"><br/>
                        ...
                        Le processus "${WorkflowVariables['title']}" sur le document <a style="color:#22aee8;text-decoration:underline;word-wrap:break-word !important;" href="${docPermalink}">${htmlEscape(docTitle)}</a>
